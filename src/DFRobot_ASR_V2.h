/*!
 * @file DFRobot_ASR_V2.h
 * @brief Define the basic structure of class DFRobot_ASR_V2
 ...
 */
#ifndef __DFROBOT_ASR_V2__
#define __DFROBOT_ASR_V2__
...
class DFRobot_ASR_V2_I2C:public DFRobot_ASR_V2
{
public:
  DFRobot_ASR_V2_I2C(TwoWire* pWire = &Wire, uint8_t addr = MODULE_I2C_ADDRESS);
...
class DFRobot_ASR_V2_UART:public DFRobot_ASR_V2
{
public:
#if defined(ARDUINO_AVR_UNO) || defined(ESP8266)
  DFRobot_ASR_V2_UART(SoftwareSerial* sSerial, uint32_t Baud = UART_BAUDRATE);
#else
  DFRobot_ASR_V2_UART(HardwareSerial* hSerial, uint32_t Baud = UART_BAUDRATE, uint8_t rxpin = 0, uint8_t txpin = 0);
#endif
